...
public class CetakBarangMin06504 extends JFrame implements ActionListener
{
...
new CetakBarangMin06504().setVisible(true);
}
...
void CetakOK()
{
 ...
 g1.drawString("create by Syafiq Insan Permana - A12.2020.06504", 10, 10);
 //cetak data....................................
try
{
//Koneksi ke table barang..................
 ...
 String strsql = "SELECT * FROM barang06504 where jumlah <= '" + 
isikanjml + "'";
 ...
 g1.drawLine(50, 135, 450, 135);
 g1.drawString("No.", 50 ,155);
 g1.drawString("Kode", 80, 155);
 g1.drawString("Nama", 150, 155);
 g1.drawString("Harga", 295, 155);
 g1.drawString("Jumlah", 390, 155);
 g1.drawLine(50, 165, 450, 165);
 x1 = 50;
 y1 = 190;
 i1 = 1;
 //Cetak Record Barang.................
...
g1.drawString(rs.getString(5),390,y1);
 y1 += 14;
 i1++;
 
 }
 
 g1.drawLine(x1, y1, 450, y1);
