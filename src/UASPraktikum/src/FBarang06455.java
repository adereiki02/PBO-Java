...
public class FBarang06455 extends JFrame implements ActionListener, MouseListener
{
...
public FBarang06455() {
			...
			btnAdd.setBounds (260, 375, 85, 25);
			btnAdd.setLabel("Add");
			btnAdd.setBackground(Color.green);
			btnAdd.setForeground(Color.getHSBColor(250,0,255));
			btnCari.setBounds (360, 375, 85, 25);
			btnCari.setLabel("Cari");
			btnKoreksi.setBounds (460, 375, 85, 25);
			btnKoreksi.setLabel("Koreksi");
			btnHapus.setBounds (560, 375, 85, 25);
			btnHapus.setLabel("Hapus");
			btnSelesai.setBounds (675, 375, 85, 25);
...
public static void main(String[] args) {
			new FBarang06455().setVisible(true);
}
...
void Add()
{
			try
			{
					 ...
					 String strsqlcr = "SELECT * FROM barang06504 WHERE kode ='" + 
fKode.getText () + "'";
					...
					if(rs.next())
					{
					 ...
					 String strsql = "insert into barang06504(kode, nama, hrgbeli, hrgjual, jumlah) values " +
...
int Cari(){
		...
		try {
				KoneksiDBMS CnPenjualan = new KoneksiDBMS();
				 ...
				 String strsql = "SELECT * FROM barang06504 WHERE kode ='" + 
fKode.getText () + "'";
...
void Koreksi()
{
			try
			{
			 ...
			 String strsql = "update barang06504 set nama='" + fNama.getText()+
...
void Hapus()
{
			try
			{
			 ...
			 String strsql = "delete from barang06504 where kode='" + 
fKode.getText()+"' ";
			 int stsproses = stat.executeUpdate(strsql);
...
void tampiltabel()
{
		try {
			 bersihtabel();
					 ...
					 String strsql = "select * from barang06504";
