...
public class FJual06455 extends JFrame implements ActionListener, FocusListener
{
			...
			private JLabel 					lNoJual 		    = new JLabel ("No. Transaksi "),
											...
											lToko1 				= new JLabel ("Ade Reiki - A12.2020.06455"),
											lToko2 				= new JLabel ("Jl. Flores Gg. 2");
...
("notransaksi"));
			...
			void Cari(){
						try 		{
									 ...
									 String sql1 = "SELECT * FROM barang06504 WHERE kode ='" + fKode.getText () + "'";
									 ResultSet rs1 = stat.executeQuery(sql1);
									if(rs1.next())
									{
												// Jika Kode Barang Ditemukan Di Tabel Barang 
						...
						try
						{
									...
									for(int i=0;i<brs;i++)
									{
											...
											String vjumlah 	  = String.valueOf(tabel.getValueAt(i,3));
											 ...
											 String strsql 		= "insert into jual06504(notransaksi, kode, harga, jumlah) " + " values ('"+ vnojual + "', '"+ vkode + "', '"+ vharga + "', '"+ vjumlah + "')";
											 
											 int stsproses = stat.executeUpdate(strsql);
											 
			//update data barang................................
											 String strsqlupdate = "update barang5049 set jumlah = jumlah - '"+ vjumlah + "' " + " where kode = '"+ vkode + "'";
