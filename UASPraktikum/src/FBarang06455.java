//library abstract window toolkit : API untuk mengembangkan GUI
import java.awt.*;
import java.awt.event.*;

//library untuk menghasilkan input dan output
import java.io.*;

//library tambahan untuk merancang GUI
import javax.swing.*;

//library untuk konek db
import java.sql.*;

//library untuk membuat table
import javax.swing.table.DefaultTableModel;

//deklarasi class dan GUI
...
public FBarang06455() {
	...
	void Add()
	{
				try
				{
						...
						String strsqlcr = "SELECT * FROM barang WHERE kode ='" + 
	fKode.getText () + "'";
	...
	int Cari(){
			...
			try {
					...
					String strsql = "SELECT * FROM barang WHERE kode ='" + 
	fKode.getText () + "'";
	...
	void Hapus()
	{
				...
				String strsql = "delete from barang where kode='" + 
	fKode.getText()+"' ";
				int stsproses = stat.executeUpdate(strsql);
