...
public class FJual06455 extends JFrame implements ActionListener, FocusListener
{
			...
			private JLabel 					lNoJual 		    = new JLabel ("No. Transaksi "),
											...
											lToko1 				= new JLabel ("Ade Reiki Karuna"),
											lToko2 				= new JLabel ("A12.2020.06455");
			...
			double total = 0, bayar = 0, kembali = 0;
			int xjumlah = 0;
			...
			new FJual06455().setVisible(true);
			}
			...
			void CariNoJual(){
						try {
								 ...
								 String sql1 = "SELECT * FROM penjualan";
								 ResultSet rs1 = stat.executeQuery(sql1);
								 if(rs1.next())
								{
										rs1.last();
										// Jika Kode Barang Ditemukan Di Tabel Barang 
										int xno = Integer.parseInt(rs1.getString ("no_transaksi"));
			...
			void Cari(){
						try 		{
									 ...
									 String sql1 = "SELECT * FROM barang WHERE kode ='" + fKode.getText () + "'";
									 ResultSet rs1 = stat.executeQuery(sql1);
									if(rs1.next())
									{
												// Jika Kode Barang Ditemukan Di Tabel Barang 
						...
						try
						{
									...
									for(int i=0;i<brs;i++)
									{
											...
											String vjumlah 	  = String.valueOf(tabel.getValueAt(i,3));
											 ...
											 String strsql 		= "insert into penjualan(no_transaksi, kode, harga, jumlah) " + " values ('"+ vnojual + "', '"+ vkode + "', '"+ vharga + "', '"+ vjumlah + "')";
											 
											 int stsproses = stat.executeUpdate(strsql);
											 
			//update data barang................................
											 String strsqlupdate = "update barang set jumlah = jumlah - '"+ vjumlah + "' " + " where kode = '"+ vkode + "'";
