...
public class FLogin06455 extends JFrame implements ActionListener, FocusListener
{
	...
	public static void main(String[] args) {
		new FLogin06455().setVisible(true);
	}
		...
		if (obj == btnOk) 	
			{
				...
				{
					this.dispose();
					FMenu06455 xmenu = new FMenu06455();
	...
	int CariPassword(){
		...
		try	{
			...
			KoneksiDBMS CnPenjualan = new KoneksiDBMS();
	   		...
	   		String strsql = "SELECT * FROM pegawai WHERE nip ='" + fNip.getText () + "' and password ='" + fPassword.getText () + "'";
	   		ResultSet rs = stat.executeQuery(strsql);
