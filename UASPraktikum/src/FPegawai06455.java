...
public class FPegawai06455 extends JFrame implements ActionListener
{
	...
	public FPegawai06455() {
		...
		lcreate.setText("Ade Reiki -- A12.2020.06455");
		...
		skrTabel.setBounds(20,195,500,190);
	...
	public static void main(String[] args) {
		new FPegawai06455().setVisible(true);
	}
...
String strsqlcr = "SELECT * FROM pegawai WHERE nip ='" + fNip.getText () + "'";
	...
	String strsql = "INSERT INTO pegawai(nip, nama, bagian, jeniskel, password) values " +
